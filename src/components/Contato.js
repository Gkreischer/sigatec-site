                ...
                <Row className="centralizaXY">
                    <Col md={6}>
                        <Row>
                            ...
                            <Col>
                                <h3><a href="tel:+552222195011">(22) 2219-5011</a></h3>
                            </Col>
                        </Row>
                        <Row>
                            <Col md={1}>
                            ...
                            <Col>
                                <h3> <a href="mailto:sigatec@gmail.com">sigatec@gmail.com</a></h3>
                            </Col>
                        </Row>
                        <Row>
                            <Col md={1}>
                            ...
                            <Col>
                                ...
                                <p> Referência: Em frente as Lojas Americanas, ao lado do restaurante Aquarius</p>
                            </Col>
                        </Row>
